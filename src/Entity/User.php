...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * Cette propriété sert à la mise en place d'un select option pour le choix du rôle au niveau du formulaire de création ou de modification d'un utilisateur
     */
    public $role;
    ...
    /**
     * Get cette propriété sert à la mise en place d'un select option pour le choix du rôle au niveau du formulaire de création ou de modification d'un utilisateur
     */ 
    ...
    /**
     * Set cette propriété sert à la mise en place d'un select option pour le choix du rôle au niveau du formulaire de création ou de modification d'un utilisateur
     *
     * @return  self
     */ 
